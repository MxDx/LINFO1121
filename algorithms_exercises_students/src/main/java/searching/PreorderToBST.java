...
public class PreorderToBST {
    ...
    */
    ...
    public Node preorderRead(int [] preOrderInput, int i, int min, int max) {
        ...
        Node nodeLeft = preorderRead(preOrderInput, i + 1, min, preOrderInput[i]);
        int leftSize = nodeLeft != null ? nodeLeft.size : 0;
        Node nodeRight = preorderRead(preOrderInput, i + leftSize + 1, preOrderInput[i], max);
        return new Node(nodeLeft, nodeRight, preOrderInput[i]);
    }
